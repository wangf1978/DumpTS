...
|**--showpack[=ps]<br>--showIPv4pack[=ps]<br>--showIPv6pack[=ps]<br>--showHCIPpack[=ps]<br>--showTCSpack[=ps]**<br>(\*)*ps=pagesize*|*N/A*|Show packs in the specified TS/MMT/TLV stream file, pagesize<=0, show all packs w/o interrupt  |
